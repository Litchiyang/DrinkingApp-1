...
Finally, I'm going to provide some suggestions regarding the things that need to be improved and implemented:
	...
	Save Instance State: Only a few OnSaveInstanceState were implemented. Before released into production the app should have a more comprehensive implementation of this.
